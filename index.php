...
$faq = [
    ...
    [
        ...
        'answer' => [
                        //first part with lists
                        [
                            "first" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:",
                            
                            "second" => [
                                
                                "one" => [
                                    
                                    "str" => "La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
                                ...
                                "two" => [
                                    "str" => "La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.",
                                ],
                            ],
                            
                            "third" => "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account."
                        ],
                        //second part with H4
                        [
...
<div id="faqContainer">
    <?php 
        foreach($googleFaq as $singleFaq){
            foreach($singleFaq as $element){
                echo $element;
            }
        }
    ?>
